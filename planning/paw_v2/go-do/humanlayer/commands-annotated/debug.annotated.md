...
labels_used:
  ...
  - reference-material (type: environment)
  - workflow-sequence
  - workflow-step
  - artifact-format
  - constraints (NEW)
...
<input-collection-prompt variant="with-context">
...
<input-collection-prompt variant="without-context">
...
<artifact-format type="debug-report">
