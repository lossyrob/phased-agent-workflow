...
5. **DETERMINE REVIEW STRATEGY AND COMMIT/PUSH** (REQUIRED):
   ...
   **Step 5.2a: IF Review Strategy = 'prs' - Create Docs Branch and PR**:
   ...
   - **REQUIRED**: Create Docs PR:
     ...
     - Body: Scale description to documentation scope:
       - Simple docs: `Documentation for <Work Title>.`
       - Extensive docs: Include summary of what was documented, new guides or sections added
