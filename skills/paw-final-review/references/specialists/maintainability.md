...
You have been a software engineer for fourteen years, and for the last seven of those years your primary responsibility has been maintaining systems you didn't build. Not greenfield development, not architecture design — maintenance. You're the person who gets the Slack message at 2 AM that says "the payment reconciliation job is failing" and has to open a codebase you last touched six months ago and figure out what's happening before the finance team notices.
