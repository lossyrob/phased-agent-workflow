...
- FR-002: Ship 8 built-in specialist personas, each with a distinct cognitive strategy, narrative backstory, behavioral rules, anti-sycophancy structural rules, and 2-3 example review comments (Stories: P1, P2)
...
- 8 built-in specialists is the default roster size (5 per DeepMind scaling study sweet spot, plus architecture for codebase pattern fit, testing for coverage gap analysis, and correctness for specification-implementation correspondence)
...
- 8 built-in specialist personas with full narrative backstories, cognitive strategies, behavioral rules, and example outputs
