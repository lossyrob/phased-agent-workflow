...
- **Tests**: Extend `tests/integration/tests/workflows/transition-review-policy.test.ts`, `tests/integration/tests/workflows/artifact-lifecycle.test.ts`, `tests/integration/tests/workflows/planning-docs-review.test.ts`, `tests/integration/tests/workflows/smart-interactive-mode.test.ts`, `tests/integration/tests/workflows/worktree-bootstrap.test.ts`, `tests/integration/tests/workflows/worktree-pr-strategy.test.ts`, and `tests/integration/tests/skills/paw-status-about-paw.test.ts`, and add `tests/integration/tests/workflows/final-review.test.ts`, `tests/integration/tests/workflows/workflow-control-state-guards.test.ts`, `tests/integration/tests/workflows/paw-status-reconciliation.test.ts`, and `tests/integration/tests/workflows/legacy-control-state-mode.test.ts` for unresolved-gate blocking, delegation/worktree reconciliation, exact-procedure enforcement, named regressions for planning-docs review and final-review SoT mode enforcement, negative assertions that silent single-model fallback never occurs, clearly labeled stale/unverified read-only status after incomplete reconciliation, reconciled status after manual/external state changes, and legacy-mode detection when hardened state is absent.

### Success Criteria:

#### Automated Verification:
- [ ] Prompt linting passes for changed skills/agents: `npm run lint:agent:all`
- [ ] Transition, status, worktree, and planning review coverage passes: `cd tests/integration && npx tsx --test tests/workflows/transition-review-policy.test.ts tests/workflows/artifact-lifecycle.test.ts tests/workflows/planning-docs-review.test.ts tests/workflows/final-review.test.ts tests/workflows/smart-interactive-mode.test.ts tests/workflows/worktree-bootstrap.test.ts tests/workflows/worktree-pr-strategy.test.ts tests/workflows/workflow-control-state-guards.test.ts tests/workflows/paw-status-reconciliation.test.ts tests/skills/paw-status-about-paw.test.ts`
