...
```
- If the file is missing or lacks a Target Branch, determine the branch (use the current branch where appropriate), then write `.paw/work/<feature-slug>/WorkflowContext.md` before proceeding.
