...
Azure DevOps executable integration remains outside this specification. Verified read/write behavior plus inferred or unobserved permission boundaries are documented in [Azure DevOps PR Capabilities](../reference/azure-devops-pr-capabilities.md).
