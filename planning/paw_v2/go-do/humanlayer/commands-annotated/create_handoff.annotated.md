...
- <file-naming-convention> (NEW) - Rules for naming/locating output files
- <output-template> (NEW) - User-facing response template
- <quality-guidelines> (NEW) - Principles/best practices for output quality
-->
