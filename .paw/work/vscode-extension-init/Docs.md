...
2. **Add project-specific rules:**
   ```markdown
   ---
   # Custom Instructions for Workflow Initialization
   ...
   This project uses additional prompt templates beyond the standard set:
   - 0Y-security-review.prompt.md - Security review checklist
   - 0Z-performance-test.prompt.md - Performance testing plan
   
   Create these additional templates alongside the standard set for every workflow.
