...
7. **Specification Assembly** (**Only after step 6 completes or research explicitly skipped**): Iteratively build the full spec with section order below. Start with narrative sections (Overview and Objectives) to establish context, then enumerate detailed requirements.
