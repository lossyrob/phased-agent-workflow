...
Azure DevOps uses this policy and preflight contract, but executable Azure DevOps integration remains outside this specification. Verified read/write behavior plus inferred or unobserved permission boundaries are documented in [Azure DevOps PR Capabilities](docs/reference/azure-devops-pr-capabilities.md).
