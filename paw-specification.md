...
- Feature branch namespace for workflow artifacts (e.g., `feature/add-authentication`)
...
- Explicit paths for non-standard layouts; defaults to `docs/agents/<target_branch>/<Artifact>.md`
