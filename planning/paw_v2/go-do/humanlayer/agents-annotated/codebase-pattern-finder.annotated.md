...
annotation-metadata:
  ...
  labels-used:
    ...
    - pattern-category (NEW) - enumeration of domain-specific search categories
---
...
<responsibility-detail id="find-implementations">
...
<responsibility-detail id="extract-patterns">
...
<responsibility-detail id="provide-examples">
...
<pattern-category type="reference">
