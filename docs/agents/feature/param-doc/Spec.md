...
## Glossary
- **WorkflowContext.md**: Centralized parameter document holding target branch, remote, issue reference, artifact paths, and optional inputs for a PAW feature workflow.
